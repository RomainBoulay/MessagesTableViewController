 ...
 *  @see WHBubbleMessageType for descriptions of the constants used to specify bubble message type.
 */
@property (assign, nonatomic, readonly) WHBubbleMessageType type;
 ...
 *
 *  @warning You may customize the propeties of textView, however you *must not* change its `font` property directly. Please use the `WHBubbleView` font property instead.
 */
 ...
 *  @param bubbleType       A constant that specifies the type of the bubble view. @see WHBubbleMessageType.
 *  @param bubbleImageView An image view initialized with an image and highlighted image for this bubble view. @see WHBubbleImageViewFactory.
 *
 *  @return An initialized `WHBubbleView` object or `nil` if the object could not be successfully initialized.
 */
...
/**
 *  Computes and returns the minimum necessary height of a `WHBubbleView` needed to display the given text.
 *
