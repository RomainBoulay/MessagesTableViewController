 ...
 */
@interface JSMessagesViewController : UICollectionViewController <UICollectionViewDataSource, UICollectionViewDelegate, UITextViewDelegate>


/**
 *  The object that acts as the delegate of the receiving messages view.
 */
@property (weak, nonatomic) id<JSMessagesViewDelegate> messageDelegate;


/**
 *  The object that acts as the data source of receiving messages view.
 */
@property (weak, nonatomic) id<JSMessagesViewDataSource> messageDataSource;


///**
// *  Returns the table view that displays the messages in `JSMessagesViewController`.
// */
//@property (weak, nonatomic, readonly) JSMessageTableView *collectionView;
