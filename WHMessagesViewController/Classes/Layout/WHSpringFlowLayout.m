...
#import "WHSpringFlowLayout.h"

@interface WHSpringFlowLayout ()
...
@implementation WHSpringFlowLayout
...
- (void)setSpringinessEnabled:(BOOL)springinessEnabled {
    ...
    if (!springinessEnabled) {
        ...
        [_visibleIndexPathsSet removeAllObjects];
    }
...
#pragma mark - WHCollectionViewCancelableLayout
- (void)setShouldUseFinalLayout:(BOOL)shouldUseFinalLayout {
    self.springinessEnabled = shouldUseFinalLayout;
}
